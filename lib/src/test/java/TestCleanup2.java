...
public class TestCleanup2 {
    ...
    @Test
    public void testCleanupUpTo() throws InterruptedException {
        UNSWArray a1 = new UNSWArray(11);
        ...
        int[] expected = {-1, -1, -1, -1, 1, 3, 5, 6, -1, 7, 9};
        assertEquals(Arrays.toString(expected), Arrays.toString(a1.getArray()));
    }

    @Test
    public void testCleanupUpToAll() throws InterruptedException {
        UNSWArray a1 = new UNSWArray(11);
        ...
        int[] expected = {-1, -1, -1, -1, -1, 1, 3, 5, 7, 9, 11};
        assertEquals(Arrays.toString(expected), Arrays.toString(a1.getArray()));
    }
